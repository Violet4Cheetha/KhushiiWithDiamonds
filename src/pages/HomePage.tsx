    ...
    <div className="space-y-12">
      <section className="relative h-96 bg-gradient-to-r from-orange-900 via-red-900 to-yellow-900 flex items-center justify-center">
        ...
        <div className="relative text-center text-white z-10">
          <img src="https://github.com/Violet4Cheetha/KhushiiWithDiamond/blob/ca3db1f9c4e816d8821a5773ff03dc6257551f71/Assets/Logo%20White%20NoBG.png" alt="Khushii With Diamond" className="pb-4"></img>
        </div>
      </section>
